...
exports.seed = function(knex, Promise) {
	...
	return Promise.all([ topicsInsertions, usersInsertions ])
		.then(() => {
			...
			// return knex('articles').insert(formattedArticle).returning('*').then((result) => {
			// 	console.log(result);
			// });
			/* 
      ...
      */
			// map through article data, change created_at = (some number) to created_at = new Date(some number)
		})
		.then((articleRows) => {
			/* 
